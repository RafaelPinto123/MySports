...
function Footer(){
    return (
        <footer className="text-center lg:text-left bg-gray-100 text-gray-600 z-0">
            <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
                <div className="mr-12 hidden lg:block">
                    <span>Mantente conectado con nuestras redes</span>
                </div>
            ...
            <div className="mx-6 py-10 text-center md:text-left">
                <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <p>
                        My Sports es una pagina donde encontraras la ultima información sobre las ligas de futbol, ademas de los ultimos videos
                    </p>
                    </div>
                    <div className="">
                    ...
                    <p className="font-semibold flex justify-center md:justify-start">
                        <Link to="/" className="text-gray-400">Inicio</Link>
                    </p>
                    <p className="font-semibold flex justify-center md:justify-start">
                        <Link to="/videos" className="text-gray-400">Videos</Link>
                    </p>
                    </div>
                    <div className="">
                        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
                        ...
                        <p className="font-semibold flex justify-center md:justify-start">
                            <Link to="/leagues" className="text-gray-400">Ligas</Link>
                        </p>
                        <p className="font-semibold flex justify-center md:justify-start">
                            <Link to="/countries" className="text-gray-400">Paises</Link>
                        </p>
                    </div>
                    <div className="">
                    <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
            ...
            <div className="text-center p-6 bg-gray-200">
                <span>© 2022 Copyright: My Sports</span>
            </div>
        </footer>
    );
}
